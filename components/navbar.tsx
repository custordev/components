...
import { GithubIcon, Youtube, ChevronDown, ShoppingCart, Layout, Layers, Home, Grid } from "lucide-react"
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="lg:flex hidden items-center gap-6 text-sm font-medium text-muted-foreground">
              ...
              <DropdownMenu open={isComponentsOpen} onOpenChange={setIsComponentsOpen}>
                ...
                <DropdownMenuContent align="start" className="w-[220px] p-2">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/components" className="flex items-center cursor-pointer font-medium">
      ...
      {NAVLINKS.map((item) => {
        const Comp = (
          <Anchor
            ...
            absolute
            className="flex items-center gap-1 dark:text-stone-300/85 text-stone-800 hover:text-foreground transition-colors"
